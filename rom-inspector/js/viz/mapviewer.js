function render_map(main) {
  main.innerHTML = `
    ...
    <p class="page-lede">
      ...
      aus <code>rom_profiles.lua</code>) zu einem vollständigen Bild zusammen &mdash; live aus
      einer lokal geladenen ROM-Datei dekodiert.
    </p>
    <div id="mapRomBanner"></div>

    <div class="toolbar">
      <select id="mapRoomSelect" style="min-width:220px;">
  ...
  function drawMap() {
    const room = ROOM_MAPS[parseInt(select.value, 10)];
