...
// ROM-wide text census: monster "<Name> bezwungen/besiegt" victory messages and named story characters, found via a targeted tools/rom/dump_strings.py scan. Only Willy and Amanda have a known live room/sprite (positionKnown=true) -- every other name was found in dialogue text only, with no live position ever captured for it (positionKnown=false, honestly labeled, not omitted). bossDefeats has no confirmed link to enemySpeciesTable's 11 numbered species rows -- shown standalone, not force-matched.
const STORY = {
  "bossDefeats": [
    {
      "bank": 13,
